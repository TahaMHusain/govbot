...
duckdb --ui ~/govbot_output/govbot.duckdb

# Or query from command line
duckdb ~/govbot_output/govbot.duckdb
```
...
govbot load --govbot-dir /path/to/govbot_output
```
...
SELECT *
FROM read_json_auto('~/govbot_output/repos/**/bills/*/metadata.json')
LIMIT 10;
